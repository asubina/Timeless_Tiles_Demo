...
public class Board : MonoBehaviour
{
    ...
    {
        public Level level; // Reference to the Level scriptable object

        // Call this function to activate the board and top UI game objects
        public void ActivateBoardAndTopUI()
        {
            // Find the board game object by name
            GameObject board = GameObject.Find("Board");
            if (board != null)
            {
                // Activate the board game object
                board.SetActive(true);
            }

            // Find the top UI game object by name
            GameObject boardTopUI = GameObject.Find(level.boardTopUIName);
            if (boardTopUI != null)
            {
                // Activate the top UI game object
                boardTopUI.SetActive(true);
            }
        }
    }
    */
